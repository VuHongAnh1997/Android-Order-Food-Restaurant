...
import com.example.androideatitserver.Service.ListenOrder;
...
public class Home extends AppCompatActivity
    ...
    private void showDialog() {
        ...
        alertDialog.setPositiveButton("YES", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if(newCategory != null){
                    database.getReference("categories").push().setValue(newCategory);
    ...
    private void loadMenu() {
        ...
        adapter.notifyDataSetChanged();//Refesh data if have data changed
    ...
    private void deleteCategory(String key) {
        ...
        database.getReference("categories").child(key).removeValue();
    ...
    private void showUpdateDialog(final String key, final Category item) {
        ...
        alertDialog.setPositiveButton("YES", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                database.getReference("categories").child(key).setValue(item);
