...
import com.example.finalapp.Model.Rating;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Order order = new Order(foodId,currentFood.getName(),numberButton.getNumber(),currentFood.getPrice(),currentFood.getDiscount());
                db.addToCart(order);
